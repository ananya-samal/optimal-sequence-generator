...
start_total_time = timeit.default_timer();  #the start time at execution
optimal_steps_array_looped = optimal_sequence_desc_with_div_looped() # optimal_steps_array_looped storing the function output
...
start_total_time = timeit.default_timer();          #the start time at execution
optimal_steps_array3 = optimal_sequence_desc_with_div_yeild() #optimal_steps_array3 storing function output
#print(type(optimal_steps_array3)) #type is list
end_total_time = timeit.default_timer();                      #end time after execution
total_execution_time = (end_total_time - start_total_time)    #time needed for entire calculation
print("optimal_sequence_desc_with_div_yeild::The execution time to reach 1 in all sequences is "+str(total_execution_time))
...
start_total_time = timeit.default_timer();           #the start time at execution
optimal_steps_array_np = optimal_sequence_using_map() #optimal_steps_array_np storing function output
end_total_time = timeit.default_timer();              #end time after execution
total_execution_time = (end_total_time - start_total_time) #time needed for entire calculation
print("optimal_sequence_using_map::The execution time to reach 1 in all sequences is "+str(total_execution_time)) 
